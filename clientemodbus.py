...
class ClienteMODBUS():
    ...
    def lerDado(self, tipo, addr):
        ...
        """
        if tipo == 1:
            return self._cliente.read_holding_registers(addr).registers[0] & self._cliente.read_holding_registers(addr+1).registers[0]
    ...
    def escreveDado(self, tipo, addr, valor):
        ...
        if tipo == 3:
            regs = self._cliente.convert_to_registers(float(valor),data_type = self._cliente.DATATYPE.FLOAT32)
